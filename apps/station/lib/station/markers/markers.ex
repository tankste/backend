    ...
    case station_info.is_open do
      true ->
        %Marker{
          ...
          e5_price: get_price(station_info, "petrol_super_e5"),
          e5_price_comparison: get_price_comparison(station_info, "petrol_super_e5", near_station_infos),
          e10_price: get_price(station_info, "petrol_super_e10"),
          e10_price_comparison: get_price_comparison(station_info, "petrol_super_e10", near_station_infos),
